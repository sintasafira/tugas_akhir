...
class siswa
{
	...
	public function create($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$nama_file,){
		try {
			if (empty($nama_file)) {
				$stmt = $this->conn->prepare("INSERT INTO tbl_siswa(nis,nisn,nama_siswa,alamat,no_telp,tempat_lahir,tgl_lahir,nama_orang_tua,sekolah_asal,tahun_lulus,kepala_sekolah,nomor_ijazah,nama_jurusan,keterangan) VALUES(:nis,:nisn,:nama_siswa,:alamat,:no_telp,:tempat_lahir,:tgl_lahir,:nama_orang_tua,:sekolah_asal,:tahun_lulus,:kepala_sekolah,:nomor_ijazah,:nama_jurusan,:keterangan,) ");
			}elseif(!empty($nama_file)){
				$stmt = $this->conn->prepare("INSERT INTO tbl_siswa(nis,nisn,nama_siswa,alamat,no_telp,tempat_lahir,tgl_lahir,nama_orang_tua,sekolah_asal,tahun_lulus,kepala_sekolah,nomor_ijazah,nama_jurusan,keterangan,foto) VALUES(:nis,:nisn,:nama_siswa,:alamat,:no_telp,:tempat_lahir,:tgl_lahir,:nama_orang_tua,:sekolah_asal,:tahun_lulus,:kepala_sekolah,:nomor_ijazah,:nama_jurusan,:keterangan,:nama_file,) ");		
	...
	public function update($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$nama_file,){
		try {

			if (empty($nama_file)) {
				$stmt = $this->conn->prepare("UPDATE tbl_siswa SET nisn=:nisn, nama_siswa=:nama_siswa, alamat=:alamat, no_telp=:no_telp, tempat_lahir=:tempat_lahir, tgl_lahir=:tgl_lahir, nama_orang_tua=:nama_orang_tua, sekolah_asal=:sekolah_asal, tahun_lulus=:tahun_lulus, kepala_sekolah=:kepala_sekolah, nomor_ijazah=:nomor_ijazah, nama_jurusan=:nama_jurusan, keterangan=:keterangan, WHERE nis=:nis");
			}else{
				$stmt = $this->conn->prepare("UPDATE tbl_siswa SET nisn=:nisn, nama_siswa=:nama_siswa, alamat=:alamat, no_telp=:no_telp, tempat_lahir=:tempat_lahir, tgl_lahir=:tgl_lahir, nama_orang_tua=:nama_orang_tua, sekolah_asal=:sekolah_asal, tahun_lulus=:tahun_lulus, kepala_sekolah=:kepala_sekolah, nomor_ijazah=:nomor_ijazah, nama_jurusan=:nama_jurusan, keterangan=:keterangan, foto=:nama_file, WHERE nis=:nis");
				$stmt->bindparam(':nama_file',$nama_file);
			}
