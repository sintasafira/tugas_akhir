<?php 
$link = mysqli_connect("localhost", "root", "", "smaitif");
...
if (isset($_POST['submit'])) {
	...
	for ($i=2; $i <=$baris; $i++) { 
		...
		$query = "INSERT INTO tbl_siswa (nis,nisn,nama_siswa,alamat,no_telp,tempat_lahir,tgl_lahir,nama_orang_tua,sekolah_asal,tahun_lulus,kepala_sekolah,nomor_ijazah,nama_jurusan,keterangan,foto,guru)values($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$foto,$guru)";
