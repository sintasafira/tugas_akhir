...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'SMAIT Ihsnanul Fikri',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0215522736',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. PABELAN 1, PABELAN, MUNGKID, MAGELANG, ',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'email : karismatif@email.com',0,'L');
...
$pdf->SetX(5);            
$pdf->MultiCell(19.5,0.5,"NIA                              : $nisn",0,'L');
$pdf->SetX(5);            
...
$pdf->SetX(5);            
$pdf->MultiCell(19.5,0.5,"NOMOR ANGGOTA          : $nomor_ijazah",0,'L');
$pdf->SetX(5);            
