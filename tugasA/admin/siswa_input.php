  ...
  <body>
  	...
  	<div class="container-fluid">
          ...
          if (isset($_POST['btn-save'])) {
            ...
            $stmt = $DB_con->prepare('SELECT * FROM tbl_siswa WHERE nomor_ijazah=:nomor_ijazah');
            $stmt->bindparam(':nomor_ijazah',$nomor_ijazah);
            $stmt->execute();
            $results = $stmt->fetch(PDO::FETCH_ASSOC);
            if (count($results)>0 && $nomor_ijazah == $results['nomor_ijazah']) {
                echo "<script> alert('Nomer ijazah ($nomor_ijazah) sudah ada') </script>";
                  ...
                  if ($ukuran_file <= 1000000) {
                    # jika ukuran file kurang dari sama dengan 1MB, lakukan:
                      ...
                      if ($result['nis']==$nis) {
                        ...
                        $siswa->create($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$nama_file,'admin');
          ...
          <div class="col-md-12">
            <form method="POST" enctype="multipart/form-data" action="">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>Nomor Anggota</td>
                  <td><input class="form-control" type="text" placeholder="Nomor Anggota" name="nomor_ijazah"></td>
                </tr>
