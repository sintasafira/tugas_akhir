  	...
  	<div class="container-fluid">
          ...
          if (isset($_POST['btn-save'])) {
            ...
            if (count($results)>0 &&  $nomor_ijazah == $results['nomor_ijazah']) {
                echo "<script> alert('Nomer Anggota ($nomor_ijazah) sudah ada') </script>";
                  ...
                  if ($ukuran_file <= 1000000) {
                    # jika ukuran file kurang dari sama dengan 1MB, lakukan:
                      ...
                      if ($result['nis']==$nis) {
                        ...
                        $siswa->create($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$nama_file,$guru);
