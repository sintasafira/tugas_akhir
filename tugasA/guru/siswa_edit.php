  						...
  						if ($tipe_file == "image/jpeg" || $tipe_file == "image/png") {
  							...
  							if ($ukuran_file <= 1000000) {
  								...
  								if (move_uploaded_file($tmp_file, $path)) { // cek apakah gambar berhasil di upload
  									...
  									$siswa->update($nis,$nisn,$nama_siswa,$alamat,$no_telp,$tempat_lahir,$tgl_lahir,$nama_orang_tua,$sekolah_asal,$tahun_lulus,$kepala_sekolah,$nomor_ijazah,$nama_jurusan,$keterangan,$nama_file,$_SESSION['nama']);
